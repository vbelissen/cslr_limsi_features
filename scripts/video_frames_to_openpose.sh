...
mkdir -p "${path2features}openpose/json/${VIDNAME}"
cd "${path2openPose}"
./build/examples/openpose/openpose.bin --image_dir "${path2frames}${VIDNAME}/" --write_keypoint_json "${path2features}openpose/json/${VIDNAME}" --hand --hand_scale_number 3 --hand_scale_range 0.4 --face --no_display
