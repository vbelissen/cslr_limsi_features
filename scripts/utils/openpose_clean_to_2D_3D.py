...
if body3D:
    ...
    np.save(path2features+'temp/'+vidName+'_3DBody', data_pose3D_final)
    ...
    np.save(path2features+'temp/'+vidName+'_headAngles_from_3Dbody', anglesTete)
...
if face3D:
    ...
    # Donnees visage 3D
    tabTot = np.load(path2features+'temp/'+vidName+'_3DFace_predict_raw_temp.npy')
    tabTot[:,     0, :] *=-1
    tabTot[:,     1, :] *=-1
