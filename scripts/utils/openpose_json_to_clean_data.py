...
(a, b, c, d) = trOP.dataReadTabPoseFaceHandLR(nimg, 0, path2features+'openpose/json/'+vidName+'/'+vidName+'_', 12, '_keypoints.json', typeData='phf', typePose='COCO')
...
(a1, b1, c1, d1) = trOP.prolongationNanDebutFin(a, b, c, d, typeData='phf', typePose='COCO')
...
(a3, b3, c3, d3) = trOP.interpNan(a1,b1,c1,d1,nimg,typeData='phf', typePose='COCO')
